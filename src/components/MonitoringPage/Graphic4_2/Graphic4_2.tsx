...
export const Graphic4_2 = () => {
  const { data } = useQuery(['4_2'], () => graphicService.getGraphic('4_2'));

  return (
    <DisclosurePanel
      title="Визуализация «уровня цифровой зрелости вспомогательных бизнес-процессов» ПК Красноярского края "
      size={24}
    >
          ...
          <GraphicSection className={styles.section}>
            ...
            <div className={styles.section_inner}>
              <Typography size={20} font="montserrat" color={EColor.blue}>
                «Уровень цифровой зрелости вспомогательных бизнес-процессов» ПК Красноярского края
              </Typography>
              <Typography size={16} font="montserrat" color={EColor.blue}>
                На основе среднеарифметического значения степени автоматизации вспомогательных бизнес-процессов
              </Typography>
              <Typography size={16} font="montserrat" color={EColor.blue}>
